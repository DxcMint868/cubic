...
- [ ] **W1 pending launch**: blocked on user adding `DATABASE_URL` to main `app/.env.local`. Then orchestrator runs `git checkout -b plan-01 main`. Launch prompt: `.agents/dispatch/plan-01.md`.
