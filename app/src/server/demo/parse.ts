...
const BASE_PROMPT_LINES = [
  ...
  '- "task.complete": {}',
  "When the user asks to BUY, PAY FOR, PURCHASE, or SETTLE the security scan",
  '(or any x402 payment wording), draft the PAID variant — this is what makes',
  'the gateway settle it for real:',
  '- "buy/pay for/purchase/settle the scan" → {"tool": "scanner.scan", "arguments": {"target": "acme/backend#421", "purchase": true, "price_usd_cents": 25}}',
