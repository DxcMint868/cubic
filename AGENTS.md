...
This project is indexed by GitNexus as **cubic** (1355 symbols, 3227 relationships, 106 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
