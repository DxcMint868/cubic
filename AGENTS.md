...
This project is indexed by GitNexus as **cubic** (477 symbols, 756 relationships, 18 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
