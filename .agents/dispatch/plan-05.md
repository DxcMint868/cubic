...
You are already on branch `plan-05` in this worktree. Do not switch plans, do not implement other plans' scope, do not touch main. A sibling agent is simultaneously implementing plan-06 (Ledger) on its own branch — stay in your fence and you will not collide.
