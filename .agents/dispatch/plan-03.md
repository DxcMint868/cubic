...
You are already on branch `plan-03` in your assigned working directory. Do not switch plans, do not implement other plans' scope, do not touch main. A sibling agent is simultaneously implementing plan-08 (network events) on its own branch — stay in your fence and you will not collide.
